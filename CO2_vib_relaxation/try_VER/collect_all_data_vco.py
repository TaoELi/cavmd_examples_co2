...
if __name__ == "__main__":
    ...
    for i, path in enumerate(paths):
        ...
        filenamelst = [path+"/init_" + filename.split("/")[-1].split(".")[0].split("_")[-1] + ".md" for filename in filenames]
        print(filenamelst)
        for j, filename in enumerate(filenames):
            if os.path.getsize(filename) >= default_file_size:
                ...
                a.output_VCO_dynamics(ntstart=0, ntend=20001, nskipping=2000, summed=False, sublist=sublist, opposite=True)
