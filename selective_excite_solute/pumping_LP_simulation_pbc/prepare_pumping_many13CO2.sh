...
do
    ...
    cp ../../equilibrium_simulation_pbc/eq_N_$Nsub\_many13CO2/data.lmp .
    cp ../../equilibrium_simulation_pbc/eq_N_$Nsub\_many13CO2/in.lmp .
    ...
    Nimpurity=$(($Nsub/216*10))
    sed -i "s/Nimpurity=10/Nimpurity=$Nimpurity/" usr_defined_function.py 
